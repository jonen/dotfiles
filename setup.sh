...
if [[ "$(uname -s)" == "Darwin" ]]; then
    ...
    # Arch Linux
    sudo pacman -Syu git tmux neovim ripgrep fd poetry starship lazygit fzf zoxide zsh eza stow npm openmp llvm clang gcc lua luarocks make wget jq yazi npm
    git clone https://github.com/tmux-plugins/tpm ~/.tmux/plugins/tpm
else
